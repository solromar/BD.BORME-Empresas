...
if __name__ == '__main__':
    ...
    db = dbConnection()
    ruta_archivo_registros = '/home/soledad/BD.BORME-Empresas/files/ultimo_archivo_procesadoAtlas.txt'
    ruta_archivo_errores = '/home/soledad/BD.BORME-Empresas/files/archivos_con_errorAtlas.txt'
