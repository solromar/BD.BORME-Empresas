...
if __name__ == '__main__':
    ...
    db = dbConnection()
    ruta_archivo_registros = '/home/soledad/BD.BORME-Empresas/files/registro_archivos_prueba_atlas.txt'
